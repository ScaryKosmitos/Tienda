...
stock y anular ventas). Una vez creada queda activa hasta que se quite, y se
pide cada vez que se hace una acción delicada. Se guarda cifrada en
configuracion.json: nunca se guarda la clave misma, solo una huella que
permite comprobarla.
